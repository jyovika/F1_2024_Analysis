...
# 2011 Plot
m1<- ggplot(median_2011, 
       aes(x = reorder(constructor, median_sec), 
           y = median_sec, 
           fill = constructor)) +
  geom_col(width = 0.8) +
  scale_fill_manual(values = team_colors_toned) +
  coord_flip() +
  labs(
    title    = "2011: Median Pit-Stop Time by Constructor",
    x        = "Constructor",
    y        = "Median Pit‐Stop Time (seconds)"
  ) +
  theme_minimal()
```
...
m2<- ggplot(median_2015, 
  ...
  coord_flip() +
  labs(
    title    = "2015: Median Pit-Stop Time by Constructor",
    x        = "Constructor",
    y        = "Median Pit‐Stop Time (seconds)"
  ) +
  theme_minimal()
...
m3<- ggplot(median_2019, 
  ...
  coord_flip() +
  labs(
    title    = "2019: Median Pit-Stop Time by Constructor",
    x        = "Constructor",
    y        = "Median Pit‐Stop Time (seconds)"
  ) +
  theme_minimal()
...
m4<- ggplot(median_2024, 
  ...
  coord_flip() +
  labs(
    title    = "2024: Median Pit-Stop Time by Constructor",
    x        = "Constructor",
    y        = "Median Pit‐Stop Time (seconds)"
  ) +
  theme_minimal()
